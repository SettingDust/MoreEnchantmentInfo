...
import settingdust.more_enchantment_info.v21.jei.EnchantmentJeiFactory as VersionedEnchantmentJeiFactory
...
class JEIMoreEnchantmentInfo : IModPlugin {
    ...
    private val factory = VersionedEnchantmentJeiFactory()
